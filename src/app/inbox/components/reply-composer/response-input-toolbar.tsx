...
const boldItem = (e: Ed) =>
  mk(
    "Bold",
    Bold,
    e.marks.bold?.isActive() ?? false,
    e.commands.toggleBold?.canExec() ?? false,
...
const italicItem = (e: Ed) =>
  mk(
    "Italic",
    Italic,
    e.marks.italic?.isActive() ?? false,
    e.commands.toggleItalic?.canExec() ?? false,
...
const underlineItem = (e: Ed) =>
  mk(
    "Underline",
    Underline,
    e.marks.underline?.isActive() ?? false,
    e.commands.toggleUnderline?.canExec() ?? false,
...
const bulletItem = (e: Ed) =>
  mk(
    "Bullet List",
    List,
    e.nodes.list?.isActive({ kind: "bullet" }) ?? false,
    e.commands.toggleList?.canExec({ kind: "bullet" }) ?? false,
...
const orderedItem = (e: Ed) =>
  mk(
    "Ordered List",
    ListOrdered,
    e.nodes.list?.isActive({ kind: "ordered" }) ?? false,
    e.commands.toggleList?.canExec({ kind: "ordered" }) ?? false,
