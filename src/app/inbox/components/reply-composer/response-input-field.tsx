...
function useReplyComposer(onSend: (body: string) => Promise<void>) {
...
function ComposerFooter({
  ...
  return (
    <div className="border-border flex items-center justify-between border-t px-2 py-1.5">
      ...
      <Button className="gap-2" onClick={onSend} disabled={sending}>
...
export default function ResponseInputField({ onSend }: ResponseInputProps) {
  const {
    editor,
    attachments,
    fileRef,
